...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsFilter() {
        ...
        config.setAllowedOriginPatterns(List.of("http://localhost:3000", "http://localhost:8080" ,"https://mini2team.lion.it.kr", "https://manittotie-beta.vercel.app/", "https://manitto-beta.vercel.app")); // 필요시 수정
